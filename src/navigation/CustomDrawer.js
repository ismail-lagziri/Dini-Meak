...
const CustomDrawer = (props) => {
  return (
    <DrawerContentScrollView {...props}>
      <View style={{ backgroundColor: '#212121', padding: 15, borderTopWidth: 1, borderTopColor: 'white' }}>
        ...
        <View style={{
          ...
          <View>
            <Text style={{ color: 'white', fontSize: 24 }}>Ismail Lagziri</Text>
            <Text style={{ color: 'lightgrey' }}>5.00 * (cmnt king)</Text>
          </View>
        </View>
